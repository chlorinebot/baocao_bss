-- Final fix for monthly schedule generation with error handling
USE bc_bss;
...
-- Test the procedure
SELECT 'Procedure created successfully! Testing...' as result;

-- Quick test (comment out if not needed)
-- CALL GenerateMonthlyScheduleFromRoles(8, 2025, 1, 'A'); 